...
if __name__ == '__main__':
    ...
    for which_expert in which_expert_list:
        ...
        # ----- Experiment settings
        experiment_name = 'biggernet_lstm_exp%d' % which_expert
        ...
        lstm_2_size_factor_list = [
            1,
            1/2,
            0
        ]
        params_list = list(itertools.product(
            model_version_list, lstm_1_size_list, lstm_2_size_factor_list
        ))
        ...
        params[pkeys.BIGGER_STAGE_2_SIZE] = 3
        params[pkeys.BIGGER_STAGE_3_SIZE] = 4
        params[pkeys.BIGGER_MAX_DILATION] = 4
        ...
        for id_try in id_try_list:
            ...
            for model_version, lstm_1_size, lstm_2_size_factor in params_list:

                params[pkeys.MODEL_VERSION] = model_version
                params[pkeys.BIGGER_LSTM_1_SIZE] = lstm_1_size
                params[pkeys.BIGGER_LSTM_2_SIZE] = int(lstm_1_size * lstm_2_size_factor)

                folder_name = '%s_%03d-%03d' % (
                    model_version,
                    params[pkeys.BIGGER_LSTM_1_SIZE],
                    params[pkeys.BIGGER_LSTM_2_SIZE]
                )
