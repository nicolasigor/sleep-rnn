...
if __name__ == '__main__':
    ...
    # ----- Experiment settings
    experiment_name = 'var_reg_first_grid'
    task_mode_list = [
        constants.N2_RECORD
    ]
    ...
    # Grid parameters
    reg_param_list = [10 ** s_exp for s_exp in range(-6, 4+1)]
    ...
    params[pkeys.TYPE_LOSS] = constants.WEIGHTED_CROSS_ENTROPY_LOSS_V2
        ...
        for dataset_name in dataset_name_list:
            ...
            for id_try in id_try_list:
                ...
                for reg_param in reg_param_list:
                    ...
                    folder_name = '%s_reg_%s' % (
                        model_version, np.log10(reg_param))
