...
if __name__ == '__main__':
    ...
    experiment_name = 'cwt_choice2_%dfold-cv_exp%d' % (n_folds, which_expert)
    ...
    # Grid parameters
    model_name_list = ['red-cwt1d']
    cv_seed_list = [0]
    cwt_cycles_list = [2, 3]
    params_list = list(itertools.product(model_name_list, cwt_cycles_list))
