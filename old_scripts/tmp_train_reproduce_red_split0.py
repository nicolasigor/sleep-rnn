...
if __name__ == '__main__':
    ...
    # Grid parameters
    model_list = [
        constants.V19, constants.V11
    ]
    repetitions_list = [1, 2, 3, 4]

    params_list = list(itertools.product(
        model_list, repetitions_list
    ))
    ...
    for task_mode in task_mode_list:
        for dataset_name in dataset_name_list:
            ...
            for id_try in id_try_list:
                ...
                for model_version, repetition in params_list:

                    params[pkeys.MODEL_VERSION] = model_version

                    folder_name = '%s_rep%d' % (
                        model_version, repetition
                    )
