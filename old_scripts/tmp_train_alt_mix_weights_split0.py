...
if __name__ == '__main__':
    ...
    # ----- Experiment settings
    experiment_name = 'alt_mix_weights'
    task_mode_list = [
        constants.N2_RECORD
    ]
    ...
    description_str = 'v11 with weights at borders and class wweight'
    verbose = True
    ...
    positive_class_weight_list = [0.25, 0.5, 1.0, 2.0, 4.0]

    params_list = list(itertools.product(
        type_loss_list, positive_class_weight_list
    ))
    ...
    params[pkeys.SOFT_LABEL_PARAMETER] = 0.1
    ...
    for task_mode in task_mode_list:
        for dataset_name in dataset_name_list:
            ...
            for id_try in id_try_list:
                ...
                for type_loss, positive_class_weight in params_list:
                    ...
                    if type_loss == constants.WEIGHTED_CROSS_ENTROPY_LOSS_HARD:
                        short_name = 'regular_xent'
                    else:
                        short_name = 'softclip_xent'

                    folder_name = '%s_c%1.2f_%s' % (
                        model_version, positive_class_weight, short_name)
