...
if __name__ == '__main__':
    ...
    description_str = 'basic linear attention grid'
    verbose = True
    ...
    params[pkeys.MODEL_VERSION] = constants.ATT03
    ...
    for task_mode in task_mode_list:
        for dataset_name in dataset_name_list:
            ...
            for id_try in id_try_list:
                ...
                for att_dim_heads_fc in att_dim_heads_fc_list:

                    params[pkeys.ATT_DIM] = att_dim_heads_fc[0]
                    params[pkeys.ATT_N_HEADS] = att_dim_heads_fc[1]
                    params[pkeys.FC_UNITS] = att_dim_heads_fc[2]

                    folder_name = '%s_d_%s_h_%s_fc_%s' % (
