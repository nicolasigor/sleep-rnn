...
if __name__ == '__main__':
    ...
    description_str = 'combined model v35 with 10 seeds'
    verbose = True
    ...
    for task_mode in task_mode_list:
        for dataset_name in dataset_name_list:
            ...
            for id_try in id_try_list:
                ...
                for model_fb in model_fb_list:

                    params[pkeys.MODEL_VERSION] = model_fb[0]
                    params[pkeys.FB_LIST] = [model_fb[1]]

                    folder_name = '%s_fb_%s' % model_fb
