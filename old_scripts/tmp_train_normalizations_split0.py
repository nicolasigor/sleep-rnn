...
if __name__ == '__main__':
    ...
    # ----- Experiment settings
    experiment_name = 'normalizations'
    task_mode_list = [
        constants.N2_RECORD
    ]
    ...
    description_str = 'v11 with normalizations'
    verbose = True
    ...
    params[pkeys.CLIP_VALUE] = 10

    for norm_mode in norm_mode_list:
        params[pkeys.NORM_COMPUTATION_MODE] = norm_mode
