...
if __name__ == '__main__':
    ...
    for which_expert in which_expert_list:
        ...
        # ----- Experiment settings
        experiment_name = 'biggernet_att_exp%d' % which_expert
        ...
        params_list = list(itertools.product(
            model_version_list, att_n_blocks_list, att_type_norm_list
        ))
        ...
        for id_try in id_try_list:
            ...
            for model_version, att_n_blocks, att_type_norm in params_list:

                params[pkeys.MODEL_VERSION] = model_version
                params[pkeys.BIGGER_ATT_N_BLOCKS] = att_n_blocks
                params[pkeys.BIGGER_ATT_TYPE_NORM] = att_type_norm

                folder_name = '%s_n%d_%s' % (
                    model_version,
                    params[pkeys.BIGGER_ATT_N_BLOCKS],
                    params[pkeys.BIGGER_ATT_TYPE_NORM]
                )
