...
if __name__ == '__main__':
    ...
    # ----- Experiment settings
    experiment_name = "tcn_without_neck"
    task_mode_list = [
        constants.N2_RECORD
    ]
    ...
    params[pkeys.TCN_USE_BOTTLENECK] = False
    ...
    for task_mode in task_mode_list:
        for dataset_name in dataset_name_list:
            ...
            for id_try in id_try_list:
                ...
                for model_version, blocks_borders in params_list:
                    ...
                    folder_name = '%s_blocks%d_border%d' % (
                        model_version, n_blocks, border_duration)
