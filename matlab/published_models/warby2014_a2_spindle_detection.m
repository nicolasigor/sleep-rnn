function [detection_samples, detection_events] = ferrarelli_spindle_detection(C3,fs,stage_file)
...
%% Standard output
detection_samples = detection;
detection_events = seq2inter( detection );
