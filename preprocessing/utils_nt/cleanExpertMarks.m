...
stats.n_marks_no_val0 = length(marks);
...
stats.n_marks_no_rep = length(newMarks);
...
stats.n_marks_valid = length(newMarks);
...
stats.n_marks_aftercomb = length(newMarks);
...
stats.n_marks_durationcontrol = length(newMarks);
...
stats.n_marks_statecontrol_n2n3 = length(newMarks);
