function [detection_samples, detection_events] = spindle_estimation_FHN2015_a8(x, fs, spindle_frequency_range)
%
...
%% Standard output
detection_events = spindles_start_end;
detection_samples = zeros(length(x),1);
for i = 1:size(detection_events,1)
    detection_samples( detection_events(i,1):detection_events(i,2) ) = 1;
end
