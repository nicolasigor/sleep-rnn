...
if __name__ == '__main__':
    ...
    experiment_name = 'bsf_without_relu'
    dataset_name_list = [
        constants.MASS_KC_NAME
    ]
    whole_night_list = [False, True]

    description_str = 'bsf kc without relu after cwt (v3-ff model)'
    which_expert = 1
    verbose = False
    ...
    for whole_night in whole_night_list:
        if whole_night:
        ...
        for dataset_name in dataset_name_list:
            ...
            for id_try in id_try_list:
                ...
                # Remove relu
                params[pkeys.MODEL_VERSION] = constants.V3_FF
