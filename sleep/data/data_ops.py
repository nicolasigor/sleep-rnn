"""data_ops.py: Module for general data eeg data operations."""
...
def norm_clip_eeg(signal, pages_indices, page_size, clip_value=10):
...
def extract_pages_with_stamps(stamps, pages_indices, page_size):
