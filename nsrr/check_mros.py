...
if __name__ == "__main__":
    print("Check MROS1")
    edf_folder = os.path.join(NSRR_PATH, "mros/polysomnography/edfs/visit1")
    annot_folder = os.path.join(NSRR_PATH, "mros/polysomnography/annotations-events-nsrr/visit1")
