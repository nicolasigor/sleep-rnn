...
if __name__ == '__main__':
    ...
    # Grid parameters
    fc_units_1_list = [256, 128]
    bn_at_fc_list = [True, False]
    drop_at_fc_list = [True, False]
    params_list = list(itertools.product(
        fc_units_1_list, bn_at_fc_list, drop_at_fc_list
    ))

    # Base parameters
    params = pkeys.default_params.copy()
    params[pkeys.MODEL_VERSION] = constants.V11_OUTPLUS
    params[pkeys.FC_UNITS_2] = 128
    ...
    for task_mode in task_mode_list:
        for dataset_name in dataset_name_list:
            ...
            for id_try in id_try_list:
                ...
                for fc_units_1, bn_at_fc, drop_at_fc in params_list:
                    model_version = params[pkeys.MODEL_VERSION]
                    params[pkeys.FC_UNITS_1] = fc_units_1
                    params[pkeys.OUTPUT_USE_BN] = bn_at_fc
                    params[pkeys.OUTPUT_USE_DROP] = drop_at_fc

                    folder_name = '%s_%d_bn%d_drop%d' % (
                        model_version, fc_units_1, bn_at_fc, drop_at_fc)
