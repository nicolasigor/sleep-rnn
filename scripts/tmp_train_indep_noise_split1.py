...
if __name__ == '__main__':
    ...
    description_str = 'training with AWGN as augmentation'
    verbose = True
    ...
    std_list = [0.3, 0.2, 0.1, 0.05]
    proba_list = [1.0, 0.5]

    params_list = list(itertools.product(
        model_list, proba_list, std_list
    ))
    ...
    for task_mode in task_mode_list:
        for dataset_name in dataset_name_list:
            ...
            for id_try in id_try_list:
                ...
                for model_version, indep_proba, indep_std in params_list:

                    params[pkeys.MODEL_VERSION] = model_version
                    params[pkeys.AUG_INDEP_GAUSSIAN_NOISE_PROBA] = indep_proba
                    params[pkeys.AUG_INDEP_GAUSSIAN_NOISE_STD] = indep_std

                    folder_name = '%s_p%1.1f_std%1.2f' % (
                        model_version, indep_proba, indep_std
                    )
