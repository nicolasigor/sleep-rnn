...
if __name__ == '__main__':
    ...
    description_str = 'v11 with hinge loss'
    verbose = True
    ...
    # Grid parameters
    type_loss_list = [constants.HINGE_LOSS]
    ...
    for task_mode in task_mode_list:
        for dataset_name in dataset_name_list:
            ...
            for id_try in id_try_list:
                ...
                for type_loss in type_loss_list:
                    model_version = params[pkeys.MODEL_VERSION]

                    params[pkeys.TYPE_LOSS] = type_loss

                    folder_name = '%s_%s_pi0.5' % (
                        model_version, type_loss)
