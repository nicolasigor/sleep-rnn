...
if __name__ == '__main__':
    ...
    description_str = 'v23 (time with output lstm)'
    which_expert = 1
    verbose = True
    ...
    params[pkeys.MODEL_VERSION] = constants.V23
    ...
    for task_mode in task_mode_list:
        for dataset_name in dataset_name_list:
            ...
            for id_try in id_try_list:
                ...
                for output_lstm_units in output_lstm_units_list:

                    params[pkeys.OUTPUT_LSTM_UNITS] = output_lstm_units

                    folder_name = 'out_lstm_%d' % output_lstm_units
