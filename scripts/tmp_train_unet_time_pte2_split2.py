...
if __name__ == '__main__':
    ...
    # ----- Experiment settings
    experiment_name = 'unet_time_pte2'
    task_mode_list = [
        constants.N2_RECORD
    ]
    ...
    type_loss_list = [constants.FOCAL_LOSS, constants.CROSS_ENTROPY_LOSS]
    n_lstm_list = [256, 128]

    param_list = list(itertools.product(
        model_version_list, init_filters_list, n_layers_list,
        type_loss_list, n_lstm_list))
    ...
    params[pkeys.FOCUSING_PARAMETER] = 1.0
    ...
    for task_mode in task_mode_list:
        for dataset_name in dataset_name_list:
            ...
            for id_try in id_try_list:
                ...
                for model_version, init_filters, n_layers, type_loss, n_lstm in param_list:
                    ...
                    params[pkeys.UNET_TIME_LSTM_UNITS] = n_lstm

                    folder_name = '%s_f_%d_ldown_%d_lstm_%d_lup_%d_%s' % (
                        model_version, init_filters, n_layers[0], n_lstm, n_layers[1], type_loss)
