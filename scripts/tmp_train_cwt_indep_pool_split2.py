...
if __name__ == '__main__':
    ...
    # ----- Experiment settings
    experiment_name = 'cwt_indep_pool'
    task_mode_list = [
        constants.N2_RECORD
    ]
    ...
    description_str = 'cwt indep using pooling'
    verbose = True
    ...
    version_filters_list = [
        (constants.V31, 64, 64, None),
        (constants.V31, 32, 64, None)
    ]
    n_scales_list = [
        64, 32
    ]
    parameter_list = list(itertools.product(version_filters_list, n_scales_list))
    ...
    for task_mode in task_mode_list:
        for dataset_name in dataset_name_list:
            ...
            for id_try in id_try_list:
                ...
                for version_filters, n_scales in parameter_list:
                    model_version = version_filters[0]
                    filters_1 = version_filters[1]
                    filters_2 = version_filters[2]
                    filters_3 = version_filters[3]

                    params[pkeys.MODEL_VERSION] = model_version
                    params[pkeys.CWT_CONV_FILTERS_1] = filters_1
                    params[pkeys.CWT_CONV_FILTERS_2] = filters_2
                    params[pkeys.CWT_CONV_FILTERS_3] = filters_3
                    params[pkeys.N_SCALES] = n_scales

                    folder_name = '%s_s_%s_f_%s_%s_%s' % (
                        model_version, n_scales, filters_1, filters_2, filters_3)
