...
if __name__ == '__main__':
    ...
    params[pkeys.CWT_NOISE_INTENSITY] = 0.05
        ...
        for dataset_name in dataset_name_list:
            ...
            for id_try in id_try_list:
                ...
                for random_waves_proba, antiborder_amplitude, model_version, focal_eps_class_weight in params_list:
                    ...
                    focal_eps = focal_eps_class_weight[0]
                    positive_class_weight = focal_eps_class_weight[1]

                    params[pkeys.AUG_RANDOM_WAVES_PROBA] = random_waves_proba
                    params[pkeys.AUG_RANDOM_ANTI_WAVES_PROBA] = random_waves_proba
