...
if __name__ == '__main__':
    ...
    params_list = list(itertools.product(
        model_version_list, blocks_borders_list, kernel_size_list
    ))
    ...
    for task_mode in task_mode_list:
        for dataset_name in dataset_name_list:
            ...
            for id_try in id_try_list:
                ...
                for model_version, blocks_borders, kernel_size in params_list:
                    ...
                    params[pkeys.TCN_KERNEL_SIZE] = kernel_size

                    folder_name = '%s_k%d_blocks%d_border%d' % (
                        model_version, kernel_size, n_blocks, border_duration)
