...
if __name__ == '__main__':
    ...
    description_str = 'v19 with 1D convs'
    verbose = True
    ...
    parameters_list = list(itertools.product(
        model_version_list, filters_list, rimp_list
    ))
    ...
    for task_mode in task_mode_list:
        for dataset_name in dataset_name_list:
            ...
            for id_try in id_try_list:
                ...
                for model_version, filters, rimp in parameters_list:

                    params[pkeys.MODEL_VERSION] = model_version
                    params[pkeys.CWT_CONV_FILTERS_1] = filters[0]
                    params[pkeys.CWT_CONV_FILTERS_2] = filters[1]
                    params[pkeys.CWT_CONV_FILTERS_3] = filters[2]
                    params[pkeys.CWT_RETURN_REAL_PART] = rimp[0]
                    params[pkeys.CWT_RETURN_IMAG_PART] = rimp[1]
                    params[pkeys.CWT_RETURN_MAGNITUDE] = rimp[2]
                    params[pkeys.CWT_RETURN_PHASE] = rimp[3]

                    folder_name = '%s_rimp_%d%d%d%d_f_%d_%d_%d' % (
                        model_version,
                        rimp[0], rimp[1], rimp[2], rimp[3],
