...
if __name__ == '__main__':
    ...
    description_str = 'red with invalid subjects'
    verbose = True
    ...
    # invalid datasets
    invalids_dict = {
        constants.MASS_SS_NAME: MassSSInv,
        constants.MASS_KC_NAME: MassKCInv
    }
    ...
    for task_mode in task_mode_list:
        for dataset_name in dataset_name_list:
            ...
            dataset_invalid = invalids_dict[dataset_name](
                dataset.global_std, params=params, load_checkpoint=True)
            data_extra = FeederDataset(
                dataset_invalid, dataset_invalid.all_ids,
            ...
            print('Extra subjects to be added:', data_extra.all_ids)
            border_size = int(params[pkeys.BORDER_DURATION] * params[pkeys.FS])
            forced_mark_separation_size = int(
                params[pkeys.FORCED_SEPARATION_DURATION] * params[pkeys.FS])
            x_extra, y_extra = data_extra.get_data_for_training(
            ...
            print('x extra', x_extra.shape, x_extra.dtype)
            print('y extra', y_extra.shape, y_extra.dtype)
            extra_data_train = (x_extra, y_extra)
