...
if __name__ == '__main__':
    ...
    for dataset_config in dataset_configs:
        ...
        for fold_id in range(len(train_ids_list)):
            ...
            # Run models
            for model_config, augment_proba in itertools.product(model_configs, augment_proba_list):
                params = copy.deepcopy(base_params)
                params.update(model_config)
                params[pkeys.AUG_RANDOM_WAVES_PROBA] = augment_proba
                params[pkeys.AUG_RANDOM_ANTI_WAVES_PROBA] = augment_proba

                folder_name = '%s_wave%d' % (model_config[pkeys.MODEL_VERSION], augment_proba)
