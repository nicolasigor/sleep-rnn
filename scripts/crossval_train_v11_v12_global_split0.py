...
if __name__ == '__main__':
    ...
    # ----- Experiment settings
    experiment_name = 'v11_v12_global'
    task_mode_list = [
        constants.N2_RECORD
    ]
    ...
    description_str = 'v11 and v12 using global normalization'
    which_expert = 1
    verbose = True
    ...
    for version_cwtf in version_cwtf_list:
        model_version = version_cwtf[0]
        cwt_filter_size_1 = version_cwtf[1]
        cwt_filter_size_2 = version_cwtf[2]
