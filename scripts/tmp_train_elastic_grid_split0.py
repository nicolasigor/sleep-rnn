...
if __name__ == '__main__':
    ...
    # ----- Experiment settings
    experiment_name = 'elastic_grid_keep_best'
    task_mode_list = [
        constants.N2_RECORD
    ]
    ...
    param_list = list(itertools.product(
        elastic_alpha_list, elastic_sigma_list))
    ...
    for task_mode in task_mode_list:
        for dataset_name in dataset_name_list:
            ...
            for id_try in id_try_list:
                ...
                for elastic_alpha, elastic_sigma in param_list:

                    params[pkeys.AUG_ELASTIC_ALPHA] = elastic_alpha
                    params[pkeys.AUG_ELASTIC_SIGMA] = elastic_sigma

                    folder_name = '%s_alpha_%1.2f_sigma_%1.3f' % (
                        model_version, elastic_alpha, elastic_sigma)
