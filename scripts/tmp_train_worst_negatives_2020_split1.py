...
if __name__ == '__main__':
    ...
    # ----- Experiment settings
    experiment_name = 'worst_negatives_2020'
    task_mode_list = [
        constants.N2_RECORD
    ]
    ...
    description_str = 'worst mining individual in red-time'
    verbose = True
    ...
    # Grid parameters
    min_negative_list = [100, 75, 50, 25]
    factor_negative_list = [4, 3, 2, 1]
    params_list = list(itertools.product(
        min_negative_list, factor_negative_list
    ))
    ...
    for task_mode in task_mode_list:
        for dataset_name in dataset_name_list:
            ...
            for id_try in id_try_list:
                ...
                for min_negative, factor_negative in params_list:
                    model_version = params[pkeys.MODEL_VERSION]
                    params[pkeys.WORST_MINING_MIN_NEGATIVE] = min_negative
                    params[pkeys.WORST_MINING_FACTOR_NEGATIVE] = factor_negative

                    folder_name = '%s_r%d_min%d' % (
                        model_version, factor_negative, min_negative)
