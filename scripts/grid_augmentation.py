...
if __name__ == '__main__':
    ...
    # ----- Experiment settings
    experiment_name = 'bsf_aug_sanity'
    ...
    noise_proba_list = [0.0]

    for rescale_proba, noise_proba in zip(rescale_proba_list, noise_proba_list):
        ...
        for dataset_name in dataset_name_list:
            ...
            for id_try in id_try_list:
                ...
                logdir = os.path.join(
                    ...
                    'rescale_%s_noise_%s' % (rescale_proba, noise_proba),
                    'seed%d' % id_try
                )
