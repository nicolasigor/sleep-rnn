...
if __name__ == '__main__':
    ...
    blocks_list = [8, 7, 6, 5, 4, 3]

    params_list = list(itertools.product(model_version_list, blocks_list))
    ...
    params[pkeys.TCN_LAST_CONV_KERNEL_SIZE] = 3
    params[pkeys.TCN_LAST_CONV_N_LAYERS] = 1
    ...
    for task_mode in task_mode_list:
        for dataset_name in dataset_name_list:
            ...
            for id_try in id_try_list:
                ...
                for model_version, blocks in params_list:
                    params[pkeys.MODEL_VERSION] = model_version
                    params[pkeys.TCN_N_BLOCKS] = blocks

                    folder_name = '%s_n%d' % (model_version, blocks)
