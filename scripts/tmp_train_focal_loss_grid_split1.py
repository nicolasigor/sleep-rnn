...
if __name__ == '__main__':
    ...
    # ----- Experiment settings
    experiment_name = 'focal_loss_grid'
    task_mode_list = [
        constants.N2_RECORD
    ]
    ...
    description_str = 'focal loss with gamma greater than 2'
    which_expert = 1
    verbose = True
    ...
    type_loss_list = [
        (constants.FOCAL_LOSS, 2.5),
        (constants.FOCAL_LOSS, 3.0),
        (constants.FOCAL_LOSS, 3.5),
        (constants.FOCAL_LOSS, 4.0),
    ]
