...
if __name__ == '__main__':
    ...
    params_list = list(itertools.product(
        model_list, positive_class_weight_list, soft_focal_eps_list, antiborder_amplitude_halfwidth_list
    ))
    ...
    for task_mode in task_mode_list:
        for dataset_name in dataset_name_list:
            ...
            for id_try in id_try_list:
                ...
                for model_version, positive_class_weight, soft_focal_eps, antiborder_amplitude_halfwidth in params_list:
                    antiborder_amplitude = antiborder_amplitude_halfwidth[0]
                    antiborder_halfwidth = antiborder_amplitude_halfwidth[1]

                    params[pkeys.MODEL_VERSION] = model_version
                    params[pkeys.CLASS_WEIGHTS] = [1.0, positive_class_weight]
                    params[pkeys.SOFT_FOCAL_EPSILON] = soft_focal_eps
                    params[pkeys.ANTIBORDER_AMPLITUDE] = antiborder_amplitude
                    params[pkeys.ANTIBORDER_HALF_WIDTH] = antiborder_halfwidth

                    folder_name = '%s_c%1.2f_eps%1.2f_ab%1.1f_hw%d' % (
                        model_version, positive_class_weight, soft_focal_eps,
                        antiborder_amplitude, antiborder_halfwidth)
