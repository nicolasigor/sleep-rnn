...
if __name__ == '__main__':
    ...
    # ----- Experiment settings
    experiment_name = 'bsf_aug_rescale_uniform'
    ...
    description_str = 'bsf data augmentation, rescale uniform intensity 0.1'
    which_expert = 1
    verbose = True
    # -----
    ...
    for dataset_name in dataset_name_list:
        ...
        for id_try in id_try_list:
            ...
            for rescale_uniform_proba in rescale_uniform_proba_list:

                params = pkeys.default_params.copy()

                # Grid parameters
                params[pkeys.AUG_RESCALE_UNIFORM_PROBA] = rescale_uniform_proba
                params[pkeys.AUG_RESCALE_UNIFORM_INTENSITY] = 0.1
                ...
                logdir = os.path.join(
                    ...
                    'rescale_unif_%s' % rescale_uniform_proba,
                    'seed%d' % id_try
                )
