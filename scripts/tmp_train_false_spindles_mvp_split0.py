...
if __name__ == '__main__':
    ...
    # ----- Experiment settings
    experiment_name = 'false_spindles_mvp'
    task_mode_list = [
        constants.N2_RECORD
    ]
    ...
    params_list = list(itertools.product(
        model_list, contamination_min_amplitude_list, contamination_frequency_range_list))
    ...
    params[pkeys.AUG_FALSE_SPINDLES_SINGLE_CONT_PROBA] = 0.5
    ...
    for task_mode in task_mode_list:
        for dataset_name in dataset_name_list:
            ...
            for id_try in id_try_list:
                ...
                for model_version, contamination_min_amplitude, contamination_frequency_range in params_list:

                    false_spindle_params = dict(
                        duration_range=[0.5, 1.5],  # [s]
                        bandstop_cutoff=[5, 17],  # [Hz]
                        spindle_frequency_range=[12, 15],  # [Hz]
                        ...
                        contamination_frequency_variation_width=2,  # [Hz]
                        contamination_amplitude_relative_range=[contamination_min_amplitude, 1.3],  # IMPORTANT
                    ...
                    folder_name = '%s_cont%1.1f-%1.1f_min%1.2f' % (
                        model_version,
                        contamination_frequency_range[0], contamination_frequency_range[1],
                        contamination_min_amplitude)
