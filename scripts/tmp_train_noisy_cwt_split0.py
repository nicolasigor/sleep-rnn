...
if __name__ == '__main__':
    ...
    noise_intensity_list = [0.1, 0.05]
    params_list = list(itertools.product(model_list, noise_intensity_list))
    ...
    for task_mode in task_mode_list:
        for dataset_name in dataset_name_list:
            ...
            for id_try in id_try_list:
                ...
                for model_version, noise_intensity in params_list:

                    params[pkeys.MODEL_VERSION] = model_version
                    params[pkeys.CWT_NOISE_INTENSITY] = noise_intensity

                    folder_name = '%s_intens%1.2f' % (model_version, noise_intensity)
