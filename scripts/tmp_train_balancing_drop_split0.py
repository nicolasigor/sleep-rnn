...
if __name__ == '__main__':
    ...
    # ----- Experiment settings
    experiment_name = 'balancing_drop'
    task_mode_list = [
        constants.N2_RECORD
    ]
    ...
    description_str = 'balancing class frequency by dropping negative outputs'
    which_expert = 1
    verbose = True
    ...
    params[pkeys.CLASS_WEIGHTS] = constants.BALANCED_DROP
