...
if __name__ == '__main__':
    ...
    # ----- Experiment settings
    experiment_name = 'worst_mining_v2'
    task_mode_list = [
        constants.N2_RECORD
    ]
    ...
    description_str = 'worst negative mining to balance cross entropy loss'
    which_expert = 1
    verbose = True
    ...
    params[pkeys.TYPE_LOSS] = constants.WORST_MINING_V2_LOSS
