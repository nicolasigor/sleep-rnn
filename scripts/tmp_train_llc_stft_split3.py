...
if __name__ == '__main__':
    ...
    description_str = 'v11 with LLC-STFT module'
    verbose = True
    ...
    for task_mode in task_mode_list:
        for dataset_name in dataset_name_list:
            ...
            for id_try in id_try_list:
                ...
                for n_samples, freq_pool, use_log, n_hidden in params_list:
                    params[pkeys.LLC_STFT_N_SAMPLES] = n_samples
                    params[pkeys.LLC_STFT_FREQ_POOL] = freq_pool
