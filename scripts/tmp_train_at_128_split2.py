...
if __name__ == '__main__':
    ...
    id_try_list = [0, 1, 2, 3]
    load_data_from_ckpt = False

    # ----- Experiment settings
    experiment_name = 'train_at_128Hz'
    task_mode_list = [
        constants.N2_RECORD
    ]
    ...
    description_str = 'training and evaluation at 128 Hz instead of 200 Hz'
    which_expert = 1
    verbose = True
    ...
    # Grid parameters
    model_version_list = [constants.V19, constants.V11]
    ...
    for task_mode in task_mode_list:
        for dataset_name in dataset_name_list:
            ...
            dataset = load_dataset(dataset_name, params=params, load_checkpoint=load_data_from_ckpt)
