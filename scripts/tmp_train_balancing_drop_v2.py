...
if __name__ == '__main__':
    ...
    # ----- Experiment settings
    experiment_name = 'balancing_drop_v2'
    task_mode_list = [
        constants.N2_RECORD
    ]
    ...
    description_str = 'balancing class frequency by dropping negative outputs (V2)'
    which_expert = 1
    verbose = True
    ...
    params[pkeys.CLASS_WEIGHTS] = constants.BALANCED_DROP_V2
