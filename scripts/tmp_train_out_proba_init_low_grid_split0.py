...
if __name__ == '__main__':
    ...
    # ----- Experiment settings
    experiment_name = 'out_proba_init_grid'
    task_mode_list = [
        constants.N2_RECORD
    ]
    ...
    description_str = 'initialization of bias, with regular xentropy loss'
    which_expert = 1
    verbose = True
    ...
    # Grid parameters
    init_proba_list = [0.1, 0.01]
    init_lr_list = [1e-4, 1e-3, 1e-2]
    ...
    for task_mode in task_mode_list:
        for dataset_name in dataset_name_list:
            ...
            for id_try in id_try_list:
                ...
                for init_proba, init_lr in itertools.product(init_proba_list, init_lr_list):
                    params[pkeys.INIT_POSITIVE_PROBA] = init_proba
                    params[pkeys.LEARNING_RATE] = init_lr

                    folder_name = 'p_%s_lr_%s' % (init_proba, init_lr)
