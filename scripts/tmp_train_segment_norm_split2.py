...
if __name__ == '__main__':
    ...
    description_str = 'normalization of input segments before NN'
    verbose = True
    ...
    params[pkeys.BORDER_DURATION] = 30
    ...
    for task_mode in task_mode_list:
        for dataset_name in dataset_name_list:
            ...
            for id_try in id_try_list:
                ...
                border_duration = params[pkeys.BORDER_DURATION]

                folder_name = '%s_border%d' % (model_version, border_duration)
