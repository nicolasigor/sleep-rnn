"""mass_ss_inv.py: Defines the MASS class that manipulates the MASS database."""
...
class MassSSInv(Dataset):
    ...
    def __init__(
        ...
        super(MassSSInv, self).__init__(
            dataset_dir=PATH_MASS_RELATIVE,
            load_checkpoint=load_checkpoint,
            dataset_name=constants.MASS_SS_INV_NAME,
            all_ids=all_ids,
