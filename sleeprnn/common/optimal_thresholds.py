...
OPTIMAL_THR_FOR_CKPT_DICT = {
    ...
    os.path.join('20201028_combi_completa_batch_n2_train_mass_ss', 'v19_waves0_ab0.0_focal1.00-1.00_batch64'): [None, 0.54, 0.48],
    os.path.join('20201028_combi_completa_batch_n2_train_mass_ss', 'v19_waves1_ab0.0_focal1.00-1.00_batch64'): [None, 0.58, 0.56],
    os.path.join('20201028_combi_completa_batch_n2_train_mass_ss', 'v19_noisy_waves0_ab0.0_focal1.00-1.00_batch32'): [None, 0.54, 0.56],
    os.path.join('20201028_combi_completa_batch_n2_train_mass_ss', 'v19_waves0_ab0.0_focal1.00-1.00_batch32'): [None, 0.56, 0.48],
    os.path.join('20201028_combi_completa_batch_n2_train_mass_ss', 'v19_noisy_waves1_ab0.0_focal0.25-0.25_batch64'): [None, 0.38, 0.40],
    os.path.join('20201028_combi_completa_batch_n2_train_mass_ss', 'v19_noisy_waves1_ab0.0_focal1.00-1.00_batch32'): [None, 0.56, 0.56],
    os.path.join('20201028_combi_completa_batch_n2_train_mass_ss', 'v19_noisy_waves0_ab0.0_focal1.00-1.00_batch64'): [None, 0.56, 0.54],
    os.path.join('20201028_combi_completa_batch_n2_train_mass_ss', 'v19_noisy_waves1_ab0.0_focal1.00-1.00_batch64'): [None, 0.54, 0.52],
    os.path.join('20201028_combi_completa_batch_n2_train_mass_ss', 'v19_waves1_ab0.0_focal1.00-1.00_batch32'): [None, 0.56, 0.56],
    os.path.join('20201028_combi_completa_batch_n2_train_mass_ss', 'v19_waves1_ab0.0_focal0.25-0.25_batch64'): [None, 0.40, 0.36],
    os.path.join('20201028_combi_completa_batch_n2_train_mass_ss', 'v19_waves0_ab0.0_focal0.25-0.25_batch64'): [None, 0.38, 0.38],
    os.path.join('20201028_combi_completa_batch_n2_train_mass_ss', 'v19_noisy_waves0_ab0.0_focal0.25-0.25_batch32'): [None, 0.40, 0.36],
    os.path.join('20201028_combi_completa_batch_n2_train_mass_ss', 'v19_noisy_waves0_ab0.0_focal0.25-0.25_batch64'): [None, 0.38, 0.40],
    os.path.join('20201028_combi_completa_batch_n2_train_mass_ss', 'v19_waves0_ab0.0_focal0.25-0.25_batch32'): [None, 0.36, 0.38],
    os.path.join('20201028_combi_completa_batch_n2_train_mass_ss', 'v19_waves1_ab0.0_focal1.00-1.00_batch8'): [None, 0.56, 0.50],
    os.path.join('20201028_combi_completa_batch_n2_train_mass_ss', 'v19_waves1_ab0.0_focal0.25-0.25_batch32'): [None, 0.38, 0.38],
    os.path.join('20201028_combi_completa_batch_n2_train_mass_ss', 'v19_noisy_waves0_ab0.0_focal1.00-1.00_batch16'): [None, 0.52, 0.52],
    os.path.join('20201028_combi_completa_batch_n2_train_mass_ss', 'v19_noisy_waves1_ab0.0_focal1.00-1.00_batch16'): [None, 0.52, 0.54],
    os.path.join('20201028_combi_completa_batch_n2_train_mass_ss', 'v19_noisy_waves0_ab0.0_focal1.00-1.00_batch8'): [None, 0.50, 0.48],
    os.path.join('20201028_combi_completa_batch_n2_train_mass_ss', 'v19_waves0_ab0.0_focal1.00-1.00_batch16'): [None, 0.48, 0.54],
    os.path.join('20201028_combi_completa_batch_n2_train_mass_ss', 'v19_noisy_waves1_ab0.0_focal1.00-1.00_batch8'): [None, 0.52, 0.48],
    os.path.join('20201028_combi_completa_batch_n2_train_mass_ss', 'v19_noisy_waves1_ab0.0_focal0.25-0.25_batch16'): [None, 0.42, 0.40],
    os.path.join('20201028_combi_completa_batch_n2_train_mass_ss', 'v19_waves1_ab0.0_focal0.25-0.25_batch16'): [None, 0.38, 0.40],
    os.path.join('20201028_combi_completa_batch_n2_train_mass_ss', 'v19_waves0_ab0.0_focal0.25-0.25_batch16'): [None, 0.40, 0.36],
    os.path.join('20201028_combi_completa_batch_n2_train_mass_ss', 'v19_noisy_waves1_ab0.0_focal0.25-0.25_batch32'): [None, 0.40, 0.38],
    os.path.join('20201028_combi_completa_batch_n2_train_mass_ss', 'v19_noisy_waves0_ab0.0_focal0.25-0.25_batch16'): [None, 0.38, 0.40],
    os.path.join('20201028_combi_completa_batch_n2_train_mass_ss', 'v19_waves1_ab0.0_focal1.00-1.00_batch16'): [None, 0.48, 0.50],
    os.path.join('20201028_combi_completa_batch_n2_train_mass_ss', 'v19_noisy_waves1_ab0.0_focal0.25-0.25_batch8'): [None, 0.38, 0.38],
    os.path.join('20201028_combi_completa_batch_n2_train_mass_ss', 'v19_waves1_ab0.0_focal0.25-0.25_batch8'): [None, 0.38, 0.40],
    ...
    os.path.join('20201130_logits_reg_n2_train_mass_ss', 'v11_1e-2_logits_reg_attractor'): [0.40, 0.54, 0.48, 0.46],
    os.path.join('20201130_logits_reg_n2_train_mass_ss', 'v11_1e-3_logits_reg_attractor_sqrt'): [0.44, 0.52, 0.52, 0.48],
    os.path.join('20201130_logits_reg_n2_train_mass_ss', 'v11_1e-3_logits_reg_norm'): [0.46, 0.48, 0.52, 0.42],
    os.path.join('20201130_logits_reg_n2_train_mass_ss', 'v11_1e-2_logits_reg_norm'): [0.44, 0.54, 0.56, 0.44],
    ...
    os.path.join('20210128_expert_reg_initial_n2_train_mass_ss', 'v11_mkd2_expertreg_feats1111_inrnn1_hid128_coef-2'): [None, 0.58, 0.48],
    os.path.join('20210128_expert_reg_initial_n2_train_mass_ss', 'v11_mkd2_expertreg_feats1111_inrnn0_hid128_coef-2'): [None, 0.48, 0.54],
    os.path.join('20210128_expert_reg_initial_n2_train_mass_ss', 'v11_mkd2_expertreg_feats1111_inrnn1_hidNone_coef-1'): [None, 0.52, 0.52],
    os.path.join('20210128_expert_reg_initial_n2_train_mass_ss', 'v11_mkd2_expertreg_feats1111_inrnn1_hidNone_coef-2'): [None, 0.48, 0.54],
    os.path.join('20210128_expert_reg_initial_n2_train_mass_ss', 'v11_mkd2_expertreg_feats1111_inrnn1_hidNone_coef0'): [None, 0.50, 0.50],
    os.path.join('20210128_expert_reg_initial_n2_train_mass_ss', 'v11_mkd2_expertreg_feats1111_inrnn1_hid128_coef0'): [None, 0.52, 0.44],
    os.path.join('20210128_expert_reg_initial_n2_train_mass_ss', 'v11_mkd2_expertreg_feats1111_inrnn1_hid128_coef-1'): [None, 0.58, 0.52],
    os.path.join('20210128_expert_reg_initial_n2_train_mass_ss', 'v11_mkd2_expertreg_feats1111_inrnn0_hidNone_coef-2'): [None, 0.44, 0.46],
    os.path.join('20210128_expert_reg_initial_n2_train_mass_ss', 'v11_mkd2_expertreg_feats1111_inrnn0_hidNone_coef-1'): [None, 0.50, 0.50],
    os.path.join('20210128_expert_reg_initial_n2_train_mass_ss', 'v11_mkd2_expertreg_feats1111_inrnn0_hidNone_coef0'): [None, 0.46, 0.46],
    os.path.join('20210128_expert_reg_initial_n2_train_mass_ss', 'v11_mkd2_expertreg_feats1111_inrnn0_hid128_coef0'): [None, 0.42, 0.36],
    os.path.join('20210128_expert_reg_initial_n2_train_mass_ss', 'v11_mkd2_expertreg_feats1111_inrnn1_hidNone_coef1'): [None, 0.36, 0.44],
    os.path.join('20210128_expert_reg_initial_n2_train_mass_ss', 'v11_mkd2_expertreg_feats1111_inrnn0_hid128_coef-1'): [None, 0.44, 0.40],
    os.path.join('20210128_expert_reg_initial_n2_train_mass_ss', 'v11_mkd2_expertreg_feats1111_inrnn1_hid128_coef1'): [None, 0.34, 0.38],
    os.path.join('20210128_expert_reg_initial_n2_train_mass_ss', 'v11_mkd2_expertreg_feats1111_inrnn0_hidNone_coef1'): [None, 0.42, 0.48],
    os.path.join('20210128_expert_reg_initial_n2_train_mass_ss', 'v11_mkd2_expertreg_feats1111_inrnn0_hid128_coef1'): [None, 0.48, 0.44],
    
    os.path.join('20210202_expert_reg_2_n2_train_mass_ss', 'v11_mkd2_expertreg_feats1111_pow(10,-4)_w1.0s'): [None, 0.54, 0.54],
    os.path.join('20210202_expert_reg_2_n2_train_mass_ss', 'v11_mkd2_expertreg_feats1111_pow(10,-4)_w4.0s'): [None, 0.54, 0.50],
    os.path.join('20210202_expert_reg_2_n2_train_mass_ss', 'v11_mkd2_expertreg_feats1111_pow(10,-3)_w2.0s'): [None, 0.56, 0.48],
    os.path.join('20210202_expert_reg_2_n2_train_mass_ss', 'v11_mkd2_expertreg_feats1111_pow(10,-2)_w1.0s'): [None, 0.58, 0.58],
    os.path.join('20210202_expert_reg_2_n2_train_mass_ss', 'v11_mkd2_expertreg_feats1111_pow(10,-2)_w0.3s'): [None, 0.52, 0.54],
    os.path.join('20210202_expert_reg_2_n2_train_mass_ss', 'v11_mkd2_expertreg_feats1111_pow(10,-2)_w4.0s'): [None, 0.54, 0.52],
    os.path.join('20210202_expert_reg_2_n2_train_mass_ss', 'v11_mkd2_expertreg_feats1111_pow(10,-4)_w2.0s'): [None, 0.50, 0.48],
    os.path.join('20210202_expert_reg_2_n2_train_mass_ss', 'v11_mkd2_expertreg_feats1111_pow(10,-4)_w0.5s'): [None, 0.46, 0.52],
    os.path.join('20210202_expert_reg_2_n2_train_mass_ss', 'v11_mkd2_expertreg_feats1111_pow(10,-3)_w4.0s'): [None, 0.50, 0.50],
    os.path.join('20210202_expert_reg_2_n2_train_mass_ss', 'v11_mkd2_expertreg_feats1111_pow(10,-3)_w1.0s'): [None, 0.48, 0.56],
    os.path.join('20210202_expert_reg_2_n2_train_mass_ss', 'v11_mkd2_expertreg_feats1111_pow(10,-1)_w4.0s'): [None, 0.46, 0.48],
    os.path.join('20210202_expert_reg_2_n2_train_mass_ss', 'v11_mkd2_expertreg_feats1111_pow(10,-2)_w2.0s'): [None, 0.50, 0.50],
    os.path.join('20210202_expert_reg_2_n2_train_mass_ss', 'v11_mkd2_expertreg_feats1111_pow(10,-3)_w0.3s'): [None, 0.52, 0.54],
    os.path.join('20210202_expert_reg_2_n2_train_mass_ss', 'v11_mkd2_expertreg_feats1111_pow(10,-4)_w0.3s'): [None, 0.48, 0.54],
    os.path.join('20210202_expert_reg_2_n2_train_mass_ss', 'v11_mkd2_expertreg_feats1111_pow(10,-2)_w0.5s'): [None, 0.50, 0.50],
    os.path.join('20210202_expert_reg_2_n2_train_mass_ss', 'v11_mkd2_expertreg_feats1111_pow(10,-3)_w0.5s'): [None, 0.50, 0.44],
    os.path.join('20210202_expert_reg_2_n2_train_mass_ss', 'v11_mkd2_expertreg_feats1111_pow(10,-1)_w2.0s'): [None, 0.52, 0.44],
    os.path.join('20210202_expert_reg_2_n2_train_mass_ss', 'v11_mkd2_expertreg_feats1111_pow(10,-1)_w1.0s'): [None, 0.50, 0.54],
    ...
    os.path.join('20210208_expert_reg_4_n2_train_mass_ss', 'v11_mkd2_expertreg_feats1100_pow(2,-7)_w1.0s'): [0.46, 0.48, 0.50, 0.46],
    os.path.join('20210208_expert_reg_4_n2_train_mass_ss', 'v11_mkd2_expertreg_feats0100_pow(2,-7)_w1.0s'): [0.42, 0.50, 0.56, 0.52],
    os.path.join('20210208_expert_reg_4_n2_train_mass_ss', 'v11_mkd2_expertreg_feats1000_pow(2,-9)_w1.0s'): [0.48, 0.54, 0.48, 0.48],
    os.path.join('20210208_expert_reg_4_n2_train_mass_ss', 'v11_mkd2_expertreg_feats1000_pow(2,-8)_w1.0s'): [0.44, 0.50, 0.54, 0.44],
    os.path.join('20210208_expert_reg_4_n2_train_mass_ss', 'v11_mkd2_expertreg_feats0100_pow(2,-8)_w1.0s'): [0.50, 0.48, 0.54, 0.48],
    os.path.join('20210208_expert_reg_4_n2_train_mass_ss', 'v11_mkd2_expertreg_feats1000_pow(2,-6)_w1.0s'): [0.46, 0.48, 0.52, 0.50],
    os.path.join('20210208_expert_reg_4_n2_train_mass_ss', 'v11_mkd2_expertreg_feats1100_pow(2,-9)_w1.0s'): [0.44, 0.48, 0.48, 0.48],
    os.path.join('20210208_expert_reg_4_n2_train_mass_ss', 'v11_mkd2_expertreg_feats1100_pow(2,-5)_w1.0s'): [0.36, 0.48, 0.46, 0.46],
    os.path.join('20210208_expert_reg_4_n2_train_mass_ss', 'v11_mkd2_expertreg_feats0100_pow(2,-6)_w1.0s'): [0.46, 0.48, 0.50, 0.48],
    os.path.join('20210208_expert_reg_4_n2_train_mass_ss', 'v11_mkd2_expertreg_feats1000_pow(2,-5)_w1.0s'): [0.48, 0.48, 0.44, 0.46],
    os.path.join('20210208_expert_reg_4_n2_train_mass_ss', 'v11_mkd2_expertreg_feats1100_pow(2,-6)_w1.0s'): [0.42, 0.50, 0.50, 0.50],
    os.path.join('20210208_expert_reg_4_n2_train_mass_ss', 'v11_mkd2_expertreg_feats0100_pow(2,-9)_w1.0s'): [0.46, 0.46, 0.50, 0.48],
    os.path.join('20210208_expert_reg_4_n2_train_mass_ss', 'v11_mkd2_expertreg_feats0100_pow(2,-5)_w1.0s'): [0.44, 0.44, 0.60, 0.50],
    os.path.join('20210208_expert_reg_4_n2_train_mass_ss', 'v11_mkd2_expertreg_feats1100_pow(2,-8)_w1.0s'): [0.46, 0.46, 0.52, 0.46],
    os.path.join('20210208_expert_reg_4_n2_train_mass_ss', 'v11_mkd2_expertreg_feats1000_pow(2,-7)_w1.0s'): [0.44, 0.54, 0.54, 0.46],
