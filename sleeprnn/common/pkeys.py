...
default_params = {
    ...
    BIGGER_STEM_KERNEL_SIZE: 3,
    BIGGER_STEM_FILTERS: 64,
    BIGGER_BLOCKS_KERNEL_SIZE: 3,
    BIGGER_STAGE_1_SIZE: 1,
    BIGGER_STAGE_2_SIZE: 1,
    BIGGER_STAGE_3_SIZE: 0,
    BIGGER_MAX_DILATION: 8,
    BIGGER_LSTM_1_SIZE: 256,
    BIGGER_LSTM_2_SIZE: 256,
    BIGGER_ATT_N_BLOCKS: None,
    BIGGER_ATT_TYPE_NORM: None,
    BIGGER_CONVOLUTION_PART_OPTION: 'multi_dilated',
